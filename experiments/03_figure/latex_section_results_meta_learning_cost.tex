...
Sensitivity analysis across $w_0 \in \{0.5, 0.6, 0.7, 0.8, 0.9\}$
shows that $w_0{=}0.6$ provides a 6\% improvement at zero statistical
cost ($p{=}0.49$ at $\alpha{=}1$), while $w_0 \geq 0.8$ incurs
...
Section~\ref{sec:catastrophic} demonstrates
