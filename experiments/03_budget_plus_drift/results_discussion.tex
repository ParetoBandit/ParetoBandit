...
\multirow{4}{*}{Moderate ($\$6.6 \times 10^{-4}$)}
  ...
  & Recalibrated     & \$7.0e-4 & $1.05\times$ \\
  & \textbf{BanditGPT} & \textbf{\$6.6e-4} & $\mathbf{0.99\times}$ \\[3pt]
\multirow{4}{*}{Loose ($\$1.9 \times 10^{-3}$)}
  & Fixed Policy     & \$9.2e-4 & $0.49\times$ \\
  & Naive Bandit     & \$5.2e-3 & $2.77\times$ \\
  & Recalibrated     & \$5.2e-3 & $2.77\times$ \\
  & \textbf{BanditGPT} & \textbf{\$1.8e-3} & $\mathbf{0.98\times}$ \\
\bottomrule
\end{tabular}
\end{center}
