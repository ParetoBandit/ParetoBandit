...
\multirow{3}{*}{Tight ($\$2.3 \times 10^{-4}$)}
  & Fixed Policy     & \$2.9e-5 & $0.13\times$ \\
  & Naive Bandit     & \$9.4e-4 & $4.02\times$ \\
  & \textbf{BanditGPT} & \textbf{\$2.4e-4} & $\mathbf{1.01\times}$ \\[3pt]
\multirow{3}{*}{Moderate ($\$6.6 \times 10^{-4}$)}
  & Fixed Policy     & \$1.3e-4 & $0.19\times$ \\
  & Naive Bandit     & \$2.1e-3 & $3.22\times$ \\
  & \textbf{BanditGPT} & \textbf{\$6.6e-4} & $\mathbf{1.00\times}$ \\[3pt]
\multirow{3}{*}{Loose ($\$1.9 \times 10^{-3}$)}
  & Fixed Policy     & \$9.1e-4 & $0.49\times$ \\
  & Naive Bandit     & \$5.4e-3 & $2.91\times$ \\
