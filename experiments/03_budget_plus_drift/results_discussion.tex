...
symmetrically in both directions: $\lambda_t$ decreases when costs
drop below target and increases when costs rise above it.
...
budget compliance to $1.00\times$--$1.01\times$ of the target across
all three regimes.
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item The \textbf{Naive Bandit} is inconsistent: it overshoots
    at tight ($\bdNaiveTightPhaseOneRatio$), overshoots at moderate
