...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item \textbf{Naive Bandit is inconsistent across budgets.}
    ...
    overshoots at tight ($1.44\times$) and moderate ($1.17\times$)
    ...
    spends \$5.2e-3/req ($2.76\times$ target).
...
budget, $\lambda_t$ overshoots ($0.55$ vs.\ $0.43$ in Phase~1),
while at loose budget it undershoots ($0.09$ vs.\ $0.10$).
