...
applies to all.  We therefore report \emph{raw-reward regret}:
$R_T = \sum_{t=1}^T [\max_a r_{a,t} - r_{a_t,t}]$,
the gap between the best arm by reward and the chosen arm.
This means regret does \emph{not} penalize cost; cost compliance
...
The defining advantage of the BudgetPacer is not lower regret
...
\begin{tabular}{@{}llrrr@{}}
\toprule
\textbf{Budget} & \textbf{Condition} & \textbf{Phase~1 Cost} & \textbf{Ratio} & \textbf{Regret} \\
\midrule
...
\paragraph{Why regret alone is misleading.}
The Naive Bandit achieves the lowest regret at moderate budget
...
BanditGPT's higher regret reflects a deliberate quality sacrifice
