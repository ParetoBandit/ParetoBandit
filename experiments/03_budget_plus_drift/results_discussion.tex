...
while ParetoBandit at moderate and loose budgets reaches $0.921$---a
gap of only $0.1$--$0.2\%$.
...
$1\%$ higher than ParetoBandit, because infinite memory converges more
...
ParetoBandit stays within $2\%$ of target.
...
\multirow{4}{*}{Tight ($\$2.3{\times}10^{-4}$)}
  ...
  & \textbf{ParetoBandit}  & $\mathbf{1.00\times}$ & $\mathbf{1.02\times}$ \\[3pt]
\multirow{4}{*}{Moderate ($\$6.6{\times}10^{-4}$)}
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item The \textbf{Recalibrated Bandit} demonstrates that
    ...
    dynamics.
    This baseline directly addresses whether ParetoBandit's advantage
