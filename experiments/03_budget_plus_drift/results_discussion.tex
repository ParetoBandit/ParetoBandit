...
At \textbf{loose} budget, $\lambda_t$ starts at $0.09$
and rapidly reaches near-zero after the price drop.
At \textbf{tight} budget, $\lambda_t$ averages $0.45$
in Phase~1 and stays elevated at $0.43$ in Phase~2---the budget
...
to ${\sim}45\%$, also converging toward the unconstrained level.
...
\midrule
Tight    & \$2.34e-4 & \$2.34e-4 & \$2.34e-4 & \$2.34e-4 & $1.00\times$ \\
Moderate & \$6.62e-4 & \$6.58e-4 & \$3.47e-4 & \$5.03e-4 & $0.76\times$ \\
Loose    & \$1.87e-3 & \$1.83e-3 & \$3.53e-4 & \$1.09e-3 & $0.58\times$ \\
\midrule
...
\midrule
Tight    & 0.852 & 0.861 & $+0.009$ & $[0.008,\; 0.011]$ \\
Moderate & 0.877 & 0.920 & $+0.043$ & $[0.040,\; 0.046]$ \\
Loose    & 0.904 & 0.920 & $+0.016$ & $[0.014,\; 0.018]$ \\
\bottomrule
\end{tabular}
\end{center}
...
($\Delta{=}+0.043$), reflecting the biggest shift from
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item \textbf{BanditGPT} is the only condition that achieves
    precise budget compliance ($0.98$--$1.00\times$ target) while
    automatically exploiting the Gemini price drop to improve quality
    ($\Delta_\mathrm{reward}{=}+0.009$ to $+0.043$).
