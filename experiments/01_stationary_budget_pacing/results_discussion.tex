...
reaches mean reward $0.813 \pm 0.0005$, while the nearest static
point ($\lambda_s{=}1.0$ at \$0.00038/req---$4.6\times$ higher
...
$0.883 \pm 0.0015$ reward vs.\ the nearest static point
($\lambda_s{=}0.5$: $0.846 \pm 0.0012$ at \$0.0011).
...
matches the pacer:
$\lambda_s{=}0$ achieves the quality ceiling ($0.922$) because it
imposes zero cost constraint.
The pacer at its loosest target ($B{=}\$0.015$) reaches $0.922$
at \$0.0094---the dual variable correctly decays to zero and the
...
under-utilisation ($0.63\times$) because the
unconstrained router's natural spend (\$0.0097/req) is already below
...
\begin{enumerate}[leftmargin=*,noitemsep]
  ...
  \item \textbf{Cost at scale.}
    ...
    Moving from the unconstrained policy (\$0.0097/req, quality~0.922)
    to the pacer at $B{=}\$0.0019$/req saves
    $(\$0.0097 - \$0.0018) \times 100{,}000 = \$790$/day
    (\textbf{\$288{,}000/year})
    while maintaining quality~$0.908 \pm 0.0007$---a 1.5\% quality
