...
(CBwK) framework~\cite{agrawal2016linear} to a per-request rate constraint suited for open-ended deployment (see Section~\ref{sec:problem} for the theoretical status of this adaptation).
