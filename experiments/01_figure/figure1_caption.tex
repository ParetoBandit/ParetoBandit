\begin{figure}[htbp]
    ...
    matches its frontier (AUC $0.871$ vs.\ $0.869$).
    %
    ...
    40.9\% of cost vs.\ 33.4\% for static mixing
    ($\Delta{=}+7.5$~pp, $95\%$~CI: $[+4.8,\;+10.2]$).
    %
    Setup: Disjoint LinUCB ($\alpha{=}0.5$,
    $n_{\mathrm{eff}}{=}5{,}000$, no Corralling);
    train $n{=}8{,}374$, val $n{=}1{,}785$, test
    $n{=}1{,}824$ prompts;
