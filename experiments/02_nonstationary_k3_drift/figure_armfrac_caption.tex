\begin{figure*}[htbp]
    ...
    ($K{=}3$; ParetoBandit $\gamma{=}0.995$, 40~seeds, 95\% bootstrap CI shading).
    %
    ...
    %
    After the reward swap at step~893, ParetoBandit shifts
    decisively toward Llama-8B, reaching 82\% Llama allocation
