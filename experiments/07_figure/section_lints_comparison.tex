...
\subsection{RQ5: Baseline Comparison and Learning Efficiency}
...
banditGPT Pareto-dominates LinTS at $K{=}3$. \textbf{TODO: update with K=3 results.}
...
LinTS (warmup)      & TODO          & --- \\
LinTS (no priors)   & TODO          & --- \\
Best Static (GPT-4.1) & TODO       & ---   \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}[leftmargin=*,nosep]
  \item \textbf{Corralling meta-learner.}
        ...
        slightly outperforms LinTS \emph{with} priors at $K{=}3$, suggesting
        prior noise.
...
The Pareto frontier is the appropriate evaluation surface for multi-model routing under cost constraints. Across the full cost spectrum, banditGPT Pareto-dominates LinTS: at any given budget, banditGPT achieves higher quality. The Corralling mechanism provides an additional safety net against prior drift, making banditGPT robust in common scenarios where cost matters, model quality is uncertain, or the deployment distribution shifts.
