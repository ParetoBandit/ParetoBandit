...
\caption{%
  ...
  AUC-only optimisation selects $\gamma{=}1.0$ for ParetoBandit
...
\begin{enumerate}[nosep,leftmargin=*]
  \item \textbf{Exploration increases for ParetoBandit.}
...
($1.0$ for ParetoBandit, $0.997$ for Tabula Rasa) is itself a
