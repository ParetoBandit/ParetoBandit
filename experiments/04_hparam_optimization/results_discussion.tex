...
\caption{%
  ...
  and $\gamma{=}0.999$ for Tabula Rasa---both near-stationary
...
is catastrophic under drift; $\gamma{=}0.999$ (half-life $693$
steps) offers minimal protection.
...
\begin{enumerate}[nosep,leftmargin=*]
  ...
  \item \textbf{Tabula Rasa exploration also increases.}
    AUC-only selects $\alpha{=}0.50$ for Tabula Rasa, while
    $\epsilon$-constraint selects $\alpha{=}0.10$.
    The lower $\alpha$ under $\epsilon$-constraint reflects
    the reduced need for exploration when forgetting
...
($1.0$ for BanditGPT, $0.999$ for Tabula Rasa) is itself a
