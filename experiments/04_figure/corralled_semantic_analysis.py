...
Usage:
    python experiments/04_figure/corralled_semantic_analysis.py --learning-rate 1.0
"""
...
def main():
    ...
    if missing_files:
        ...
        if any(name == '1M Dataset' for name, _ in missing_files):
            print("   • 1M Dataset: Run 'python experiments/appendix_d/download_1M_dataset.py'")
    ...
    if not data_1M_file.exists():
        ...
        print(f"      python experiments/appendix_d/download_1M_dataset.py")
        print(f"\n   Exiting...")
        sys.exit(1)
