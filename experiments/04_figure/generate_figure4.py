#!/usr/bin/env python3
"""
Figure 4: Multi-Model Cost-Quality Pareto Frontier (K=5 and K=10)
=================================================================
...
Saves: results/figure4_multimodel_pareto.pdf and .png
"""
...
def main():
    ...
    fig.suptitle(
        "Figure 4: Multi-Model Routing — banditGPT at K=5 and K=10",
