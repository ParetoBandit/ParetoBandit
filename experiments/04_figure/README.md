# Figure 4: Multi-Model Pareto Frontier (K=5, K=10)
...
python experiments/04_figure/run_multimodel_pareto.py
# Output: experiments/04_figure/results/multimodel_pareto_results.json
```
