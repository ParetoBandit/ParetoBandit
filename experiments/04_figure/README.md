...
python experiments/04_figure/quick_test_3models.py
```
...
python experiments/04_figure/corralled_semantic_analysis.py \
    --learning-rate 1.0 \
    --gamma 0.05 \
    --train-size 1121 \
...
python experiments/04_figure/run_ablation_studies.py
```
...
python experiments/04_figure/plot_convergence_analysis.py

# Analyze cost-quality tradeoffs and model discovery
python experiments/04_figure/analyze_cost_quality_tradeoff.py
```
