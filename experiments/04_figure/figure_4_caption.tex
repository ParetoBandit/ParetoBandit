...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{experiments/04_figure/results/figure4_model_discovery.png}
\caption{%
...
\begin{itemize}[nosep]
    \item \textbf{Short-term (first $\sim$100--300 steps):} Semantic transfer provides immediate benefit via implicit regularization (breaking symmetry), accelerating adoption compared to cold start.
