...
\begin{enumerate}[nosep,leftmargin=*]
  ...
  \item \textbf{Forgetting Bandit ($\gamma{=}0.995$):}
    Same matched static cost penalty as the Naive Bandit, but with
    the same forgetting factor as ParetoBandit ($\gamma{=}0.995$).
...
\multirow{5}{*}{Tight ($\$3.0 \times 10^{-4}$)}
  ...
  & Forgetting Bandit & \bdForgetTightPhaseOneCost & $\bdForgetTightPhaseOneRatio$ \\
...
\multirow{5}{*}{Moderate ($\$6.6 \times 10^{-4}$)}
  ...
  & Forgetting Bandit & \bdForgetModPhaseOneCost & $\bdForgetModPhaseOneRatio$ \\
...
\multirow{5}{*}{Loose ($\$1.9 \times 10^{-3}$)}
  ...
  & Forgetting Bandit & \bdForgetLoosePhaseOneCost & $\bdForgetLoosePhaseOneRatio$ \\
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item \textbf{Forgetting Bandit is the worst offender}
    ...
    This condition shares ParetoBandit's $\gamma{=}0.995$ but replaces
...
Mistral's.
The \textbf{Forgetting Bandit} ($\gamma{=}0.995$) shifts faster:
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item The \textbf{Forgetting Bandit} ($\gamma{=}0.995$, same
