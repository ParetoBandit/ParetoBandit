...
With geometric forgetting $\gamma{=}0.997$, Phase~1 observations are
...
\begin{enumerate}[nosep,leftmargin=*]
  ...
  \item \textbf{Forgetting Bandit ($\gamma{=}0.997$):}
    Same matched static cost penalty as the Naive Bandit, but with
    the same forgetting factor as ParetoBandit ($\gamma{=}0.997$).
  ...
  \item \textbf{ParetoBandit (Pacer + $\gamma{=}0.997$):}
...
\noindent
An \textbf{unconstrained ParetoBandit} baseline (same $\gamma{=}0.997$,
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item \textbf{Forgetting Bandit is the worst offender}
    ...
    This condition shares ParetoBandit's $\gamma{=}0.997$ but replaces
...
Mistral's.
The \textbf{Forgetting Bandit} ($\gamma{=}0.997$) shifts faster:
...
The unconstrained baseline shares ParetoBandit's $\gamma{=}0.997$ but
...
(Section~\ref{sec:hparam_sweep}) selected $\gamma{=}0.997$ because
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item The \textbf{Forgetting Bandit} ($\gamma{=}0.997$, same
