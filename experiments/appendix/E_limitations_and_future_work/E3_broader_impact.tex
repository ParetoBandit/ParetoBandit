...
potential: at $\lambda{=}1.0$ with a $K{=}10$ portfolio, banditGPT achieves
89\% cost reduction over static frontier-model routing with only 5.4\%
quality loss---corresponding to approximately \$110k annual savings at
100k requests/day.  If widely deployed, this could lower the cost barrier
...
$K{=}10$, no single model exceeds 16\% of traffic, so a single-provider
outage affects at most 16\% of requests---a property absent from static
