...
constraints may be needed for high-stakes applications.  The $K{=}3$
multi-model results (Section~5.2) underscore this concern: at
$\lambda{=}1$, the router achieves substantial cost reduction versus
static GPT-4.1 by routing traffic to cheaper
...
detection rate at $K{=}3$), which reduces user exposure to harmful
...
catastrophic failure simulations across $K{\in}\{2,3\}$, model
