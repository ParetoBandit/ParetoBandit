...
\chMinCohensD{} (Mistral-Large $\to$ Gemini-Pro) to \chMaxCohensD{}
(Llama-8B $\to$ Mistral-Large)---well above $d{=}1$, consistent with the
100\% ranking preservation reported above.
In the $K{=}4$ portfolio, the Mistral-Large $\to$ Gemini-Flash pair has
$d = \chMFCohensD$; this weakest separation corresponds to the only pair
