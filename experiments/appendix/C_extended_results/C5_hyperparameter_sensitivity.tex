...
\midrule
0.1 & 0.9015 & $\pm$0.0054 \\
0.3 & 0.9063 & $\pm$0.0055 \\
0.5 & 0.9091 & $\pm$0.0032 \\
1.0 (default) & 0.8973 & $\pm$0.0152 \\
2.0 & 0.8997 & $\pm$0.0108 \\
5.0 & 0.8979 & $\pm$0.0125 \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Finding.}
Performance is stable across a 50$\times$ range of $\eta$ (0.1 to
5.0), with all rewards falling within 0.897--0.909 (a 1.2\% spread).  The
default $\eta{=}1.0$ achieves 0.897, within CI of the best (0.909 at
$\eta{=}0.5$).  Higher $\eta$ values produce wider confidence intervals,
...
\midrule
0.5  & 0.9110 & $\pm$0.0034 \\
1.0  & 0.9065 & $\pm$0.0060 \\
2.0 (default)  & 0.9040 & $\pm$0.0071 \\
4.0  & 0.9029 & $\pm$0.0031 \\
\bottomrule
\end{tabular}
\end{table}
...
rewards in 0.903--0.911 (0.8\% spread).  All values are within each
...
performance degrades by $<1.2\%$ across order-of-magnitude hyperparameter
