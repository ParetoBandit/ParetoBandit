...
\midrule
0.1 & 0.9158 & $\pm$0.0015 \\
0.3 & 0.9162 & $\pm$0.0020 \\
0.5 & 0.9151 & $\pm$0.0024 \\
1.0 (default) & 0.9156 & $\pm$0.0024 \\
2.0 & 0.9132 & $\pm$0.0044 \\
5.0 & 0.9135 & $\pm$0.0040 \\
\bottomrule
\end{tabular}
\end{table}
...
5.0), with all rewards falling within 0.9132--0.9162 (a 0.3\% spread).  The
default $\eta{=}1.0$ achieves 0.9156, indistinguishable from the best (0.9162
at $\eta{=}0.3$).  Higher $\eta$ values produce slightly wider confidence
intervals, consistent with more volatile meta-weight switching, but the mean
reward difference is negligible.
...
\midrule
0.5  & 0.9138 & $\pm$0.0047 \\
1.0  & 0.9161 & $\pm$0.0034 \\
2.0 (default)  & 0.9164 & $\pm$0.0025 \\
4.0  & 0.9145 & $\pm$0.0035 \\
\bottomrule
\end{tabular}
\end{table}
...
rewards in 0.9138--0.9164 (0.3\% spread).  The default $\alpha_{\text{start}}
{=}2.0$ is near-optimal.  Under-exploration ($\alpha_{\text{start}}{=}0.5$)
produces slightly wider CIs, suggesting more variance due to insufficient
early exploration.

\subsubsection{Implications}

Both $\eta$ and $\alpha_{\text{start}}$ exhibit a broad plateau:
performance degrades by $<0.3\%$ across order-of-magnitude hyperparameter
