...
8                 & 0.9051 & $\pm$0.0066 \\
16                & 0.9047 & $\pm$0.0058 \\
32 (default)      & 0.9104 & $\pm$0.0027 \\
64                & 0.9097 & $\pm$0.0042 \\
128               & 0.9038 & $\pm$0.0038 \\
\bottomrule
\end{tabular}
\end{table}
...
with rewards in $[0.904, 0.910]$ (0.6\% spread).  The very lowest
dimension ($d{=}4$) shows similar performance to $d{=}8$ at this $K{=}2$ scale.
The default $d{=}32$ achieves the highest mean (0.910) with the
narrowest CI ($\pm 0.003$).
...
effectively rank-2.  At $K{=}3$, $d{=}4$ retains sufficient signal; at $K{=}5$, $d{=}4$ loses one model's expertise
...
3                 & 0.9015 & $\pm$0.0069 \\
5                 & 0.8979 & $\pm$0.0084 \\
10 (default)      & 0.9015 & $\pm$0.0054 \\
20                & 0.9018 & $\pm$0.0071 \\
50                & 0.9047 & $\pm$0.0036 \\
100               & 0.9027 & $\pm$0.0060 \\
\bottomrule
\end{tabular}
\end{table}
...
1 to 100 yield rewards within 0.7\% of each other (0.898--0.905).  This
...
(prior-only) to 0.893, indicating that online adaptation rapidly dominates
