...
\midrule
banditGPT vs.\ RouteLLM-MF & $+0.031$ & 22.04 & $5.4 \times 10^{-15}$ & 4.93 & $8.7 \times 10^{-5}$ \\
banditGPT vs.\ Static Mixtral & $+0.091$ & 7.01 & $5.2 \times 10^{-12}$ & 0.28 & $1.2 \times 10^{-10}$ \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Bootstrap CI.}
The 95\% bootstrap CI for banditGPT's mean reward is $[0.911, 0.917]$,
...
Cohen's $d = 4.93$ is far above the ``large'' threshold ($d \geq 0.8$),
and every one of banditGPT's 20 trial means (range: 0.899--0.923) exceeds
RouteLLM-MF's best threshold reward (0.883).  The 95\% bootstrap CI
$[0.911, 0.917]$ entirely excludes the RouteLLM-MF reference, providing
...
even the lower bound (0.911) exceeds the RouteLLM-MF reference by 2.8
