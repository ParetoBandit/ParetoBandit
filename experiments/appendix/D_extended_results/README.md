...
**File**: `D1_catastrophic_failure.tex`  
...
## Related Sections
- **Appendix C.1**: Corralling ablation validates hyperparameter choices
...
D_extended_results/
├── README.md                         (this file)
└── D1_catastrophic_failure.tex       (included in APPENDIX_MASTER)
```
