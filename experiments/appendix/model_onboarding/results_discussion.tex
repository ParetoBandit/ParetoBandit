...
It achieves a reward of 0.893, which ParetoBandit matches or exceeds
...
Under budget constraints, Gemini-Pro is rarely selected ($<2\%$ of Phase~2 traffic at the moderate target).
