...
The standard industry workflow for integrating a new model is:
\begin{enumerate}[nosep,leftmargin=*]
  \item Run an offline evaluation (days to weeks of human or LLM-judge
    annotation).
  \item Retrain the routing policy on the updated dataset.
...
$\gamma{=}0.997$, consistent across all main-body experiments.
