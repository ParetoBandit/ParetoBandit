...
\begin{table}[h]
\centering
\caption{Expected reward ordering under each judge ($n = 2{,}000$
prompts; Bonferroni-corrected bootstrap CIs, 9 comparisons,
$B = 10{,}000$).}
...
Conditioning on R1's gap bins when validating
