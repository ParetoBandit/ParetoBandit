# Prior Degradation Sweep (Appendix E)
...
\input{experiments/appendix/E_prior_degradation/latex_figure3_combined_caption}

% Strategy selection table
\input{experiments/appendix/E_prior_degradation/latex_table_strategy_guide}

% Practical deployment recommendations
\input{experiments/appendix/E_prior_degradation/latex_section_5.3_practical_recommendations}
```
