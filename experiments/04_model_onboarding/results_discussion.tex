...
\paragraph{Strategy.}
ParetoBandit (transfer): Phase~1 posteriors carry over; Flash gets a
T-shirt prior plus 20-prompt forced burn-in.
...
ParetoBandit stays within the budget target at every tier.
