...
\paragraph{Hallucination Metrics.}
We collect hallucination rates from the Vectara Hallucination Leaderboard~\cite{vectara2024hallucination}:
%
\begin{itemize}[nosep]
\item Test set: 1,000 short-form factual questions
\item Evaluation: Expert human annotation for factual errors
\item Metric: Percentage of responses containing hallucinations
\end{itemize}
%
We convert hallucination rate $h$ to factual consistency via $S_{\text{factual}} = 100 - h$.

\paragraph{Human Preference Signals.}
