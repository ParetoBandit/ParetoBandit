...
The exhaustive grid-search logs, heatmaps, and per-seed variance
breakdowns are reported in Appendix~\\ref{app:hparam_sweep_details}
(generated by ``experiments_v2/appendix/hparam_sweep/run_hparam_sweep.py``).
...
Usage::
    ...
    python experiments_v2/04_hparam_optimization/run_hparam_sweep.py
"""
