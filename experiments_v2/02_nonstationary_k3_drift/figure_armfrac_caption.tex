\begin{figure*}[htbp]
    \centering
    \includegraphics[width=\linewidth]{../experiments_v2/02_nonstationary_k3_drift/results/reward_shift_arm_fractions.pdf}
    ...
    decisively toward Llama-8B, reaching 69\% Llama allocation
    by step~1{,}785.  The Mistral-Large fraction (orange) shrinks
    rapidly in Phase~2 as the forgetting
    ...
    %
    The adaptive-$\gamma$ condition
    (Figure~\ref{fig:gamma_trajectory}) produces nearly identical
    arm fractions (71\% Llama at termination), confirming that the
    residual-based detector triggers forgetting at the correct time
    and magnitude.
    }
