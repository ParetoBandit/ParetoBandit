...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{experiments_v2/appendix/hparam_sweep/results/hparam_sweep_heatmap.png}
\caption{%
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{experiments_v2/appendix/hparam_sweep/results/hparam_sweep_alpha.png}
\caption{%
