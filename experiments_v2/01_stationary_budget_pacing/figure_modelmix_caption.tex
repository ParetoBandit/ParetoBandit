\begin{figure*}[htbp]
    \centering
    \includegraphics[width=\linewidth]{../experiments_v2/01_stationary_budget_pacing/results/model_mix.pdf}
    ...
    smoothly shifts the mix from Gemini-dominant (51\% at $\lambda_s{=}0$)
    to Llama-dominant (98\% at $\lambda_s{=}1.0$), with Mistral peaking
    at intermediate values (${\sim}54\%$ at $\lambda_s{=}0.3$).
    ...
    Llama/Mistral blend (51\%/46\%) that is not reachable by any single
    static $\lambda_s$ value: the nearest static point ($\lambda_s{=}0.5$,
    64\%/33\%) overweights Llama at the expense of quality.
