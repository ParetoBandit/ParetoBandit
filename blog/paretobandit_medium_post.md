...
We simulate exactly this three-phase scenario ([paper, Section 4.3, p. 7](https://github.com/ParetoBandit/ParetoBandit/blob/main/paper/main.pdf)). In Phase 1, everything runs normally. In Phase 2, Gemini-Pro's pricing drops from $0.015/request to $0.0003/request. In Phase 3, original pricing is restored.
