...
def test_stability_check_triggers():
    ...
    print("  Forgetting Factor: 0.85 (aggressive decay)")
    ...
    if reset_triggered:
        ...
        print("   Matrix was successfully stabilized!")
        return True
    elif instability_detected:
        print("\n⚠️ PARTIAL: Instability occurred but didn't trigger reset")
        print("   This might happen if threshold is too high")
        ...
        print("   This is actually GOOD - means decay is well-controlled!")
