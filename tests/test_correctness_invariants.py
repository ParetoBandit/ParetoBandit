...
class TestBug9_DeepCopy:
    """
    The old __deepcopy__ referenced removed attributes and omitted attributes
    added since (verbose_routing, log_index, market anchors, etc.), producing
    a broken clone.
    ...
    def test_deepcopy_has_all_init_attributes(self):
        ...
        expected_attrs = [
            ...
            "bandit", "cost_penalty", "latency_penalty",
