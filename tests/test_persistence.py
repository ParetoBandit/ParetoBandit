...
from pareto_bandit.storage import EphemeralContextStore, SqliteContextStore
...
def test_sqlite_write_read():
    ...
    try:
        ...
        print("✓ Read context back successfully")
...
def test_sqlite_ttl_pruning():
    ...
    try:
        ...
        print("✓ Context successfully removed after TTL expiration")
...
def test_ephemeral_store():
    ...
    print("✓ Saved 3 contexts (max_size=3)")
    ...
    print("✓ All 3 contexts retrievable")
...
def test_missing_context():
    ...
    try:
        ...
        print("✓ Missing context returns (None, None)")
