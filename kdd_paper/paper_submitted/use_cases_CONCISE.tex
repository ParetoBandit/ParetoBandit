...
\centering
\small
\caption{\textbf{Accessibility Requirements.} Figures for time are approximate and based on representative small-team deployments; BanditGPT requires only a one-time configuration step.}
\label{tab:accessibility_comparison}
\begin{tabular}{lccc}
\toprule
\textbf{Requirement} & \textbf{FrugalGPT} & \textbf{RouteLLM} & \textbf{BanditGPT} \\
\midrule
Calibration Data & Hundreds to low thousands & Thousands of pairs & 0 \\
Scorer Training & BERT finetune & Classifier & No \\
Model Addition & 1--3 days & 1--2 days & 30 seconds \\
