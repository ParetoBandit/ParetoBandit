#!/usr/bin/env python3
"""
Download Offline Battle Data and Create Rewards Dataset

This script downloads and processes the battle corpus (battle dataset) curated by the
RouteLLM project on HuggingFace. It does NOT download the RouteLLM router package.
The dataset contains pairwise model comparisons with correct reward mapping.
...
Validated by sanity check: GPT-4 wins more than Mixtral overall (matching the RouteLLM paper).
...
def download_and_process(args):
    ...
    print("="*80)
    print("DOWNLOAD OFFLINE BATTLE DATA (RouteLLM dataset)")
    print("="*80)
    ...
    print(f"\n📥 Step 1/3: Downloading battle corpus from HuggingFace...")
    ...
    print("SUMMARY")
    print("="*80)
    print(f"   ✅ Downloaded and processed offline battle corpus")
...
def main():
    parser = argparse.ArgumentParser(
        description="Download and process offline battle data (RouteLLM dataset)",
