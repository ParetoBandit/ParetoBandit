#!/usr/bin/env python3
"""Backfill for Gemini models with Claude Sonnet 4.5 as judge."""
...
class GeminiBackfiller:
    def __init__(self, api_key):
        self.api_key = api_key
        self.base_url = "https://openrouter.ai/api/v1"
        self.judge = "anthropic/claude-sonnet-4.5"  # Claude as judge for Gemini
...
if __name__ == "__main__":
    backfiller = GeminiBackfiller(API_KEY)
    
    # Process Gemini model
