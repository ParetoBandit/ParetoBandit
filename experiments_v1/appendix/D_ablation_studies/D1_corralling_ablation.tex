...
This weak initialization allows the bandit algorithm to rapidly learn GPT-4o's true performance through exploration, discovering it as the dominant choice (70.8\% usage) while the warmup expert's strong GPT-4-Turbo bias (79.9\% in isolation) is correctly identified as suboptimal.
