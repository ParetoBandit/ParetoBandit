...
\begin{enumerate}[leftmargin=*,nosep]
    \item \textbf{High confidence, wrong decisions:} Warmup priors encode strong beliefs about model preferences (favor GPT-4-Turbo for technical content). These beliefs are \emph{confident} (high exploitation) but \emph{wrong} for conversational queries.
