...
\textbf{Cost Savings at Scale:} The 75.7\% cost reduction translates to substantial savings for high-volume applications. At 1M tokens/day, switching from GPT-4-Turbo-only (\$10/1M) to the learned policy (\$2.43/1M) saves \$7.57/day or \$2,760/year. At 1B tokens/day (typical for enterprise applications), savings reach \$7,570/day or \$2.76M/year---achieved without explicit cost optimization or quality degradation (reward: 0.939 vs theoretical maximum 1.0).

\textbf{Handling New Models:} When new models become available (e.g., GPT-4o release), use semantic transfer instead of retraining from scratch. Initialize the new model's priors from the most similar existing model (determined by cost tier, capability, or provider) with conservative gamma scaling ($\gamma=0.05$). This provides a reasonable starting point while allowing rapid online adaptation. Our results show the router discovered GPT-4o as the dominant choice (70.8\%) despite starting with GPT-4-Turbo-biased priors.
