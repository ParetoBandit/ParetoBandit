...
BanditGPT routes prompts to models using contextual features extracted by \texttt{FeatureService}: sentence embeddings compressed to 33 dimensions via PCA.
...
\begin{enumerate}[noitemsep,topsep=2pt]
    ...
    \item \textbf{The signal is a lower bound.} PC1 is one dimension; the router uses all 33 PCA components. The full feature vector likely captures more predictive signal than PC1 alone.
