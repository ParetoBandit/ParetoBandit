...
- **Figure 1** (`experiments_v1/01_figure/`): PCA validation — cross-domain generalization
- **Table 2** (`experiments_v1/02_table/`): Domain mismatch — Corralling under distribution shift
- **Figure 4** (`experiments_v1/04_figure/`): Multi-model routing — 3+ model discovery
- **Figure 5** (`experiments_v1/05_figure/`): Pareto frontier — cost-quality tradeoffs
