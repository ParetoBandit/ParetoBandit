...
\textit{Regime-Dependent Selection ($t=0$-$800$):} Meta-learner exhibits binary regime switching based on data-prior match. Individual seeds show decisive commitment (100\%) to either Conservative (blue, with semantic transfer) or Adaptive (red, tabula rasa) expert. Averaged across 30 seeds: $\sim$30\% warmup-dominant regimes, $\sim$70\% tabula rasa-dominant regimes. Pre-release mean reward: $3.38 \pm 0.38$.
...
\textit{Meta-Learner Dynamics Demonstrate Adaptive Intelligence:} The key observation is that Corralling makes \textbf{decisive commitments} (100\% to one expert per seed) based on data-prior match quality. This binary regime switching is \textit{evidence of adaptive intelligence}, not rigid averaging. 
...
%% Figure moved to top of section - see figure7_caption.tex
