...
class CheckpointManager:
    ...
    **What Does NOT Get Saved**:
    ...
    def save(self, router_instance: Any) -> None:
        """
        ...
        **Atomic Write Pattern**:
        ...
        state = {
            ...
            "A": dict(router_instance.bandit.A.items()),
            "b": dict(router_instance.bandit.b.items()),
            "last_update": dict(router_instance.bandit.last_update.items()),
            "last_played": dict(router_instance.bandit.last_played.items()),
            "models": router_instance.bandit.models,
            "timestamp": time.time(),
        }
    ...
    def load(self, router_instance: Any) -> bool:
        """
        ...
        **Registry Drift Handling**:
        ...
        try:
            ...
            # Backward compat: checkpoints saved before last_played was added
            router_instance.bandit.last_played = state.get(
                "last_played",
                dict(state["last_update"].items()),
            )
