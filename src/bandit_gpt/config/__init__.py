...
# Portfolio-specific warmup priors extracted from the 43-model artifact.
# Filtered to only the models in each experiment's portfolio — avoids
# information leakage from models outside the test set.
WARMUP_PRIORS_DIR = DATA_COLLECTION_DIR / "warmup_priors"
K2_WARMUP_PRIORS_PATH = WARMUP_PRIORS_DIR / "priors_warmup_k2_6comp.joblib"
K10_WARMUP_PRIORS_PATH = WARMUP_PRIORS_DIR / "priors_warmup_k10_6comp.joblib"
...
EMBEDDINGS_CACHE_PATH = EMBEDDINGS_CACHE_DIR / "embeddings_pca6.npz"
