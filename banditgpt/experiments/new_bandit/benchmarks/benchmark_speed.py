#!/usr/bin/env python3
"""
Benchmark: O(d²) Sherman-Morrison Efficiency

Proves that the fixed Sherman-Morrison update path achieves O(d²) complexity
...
CRITICAL TEST: Forces the DECAY SCENARIO (dt > 0) on every step to verify
that time decay does NOT trigger full matrix inversion.
