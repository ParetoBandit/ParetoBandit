#!/usr/bin/env python3
"""
Test the numerical stability safety check.

Simulates a scenario where one arm gets zero traffic while others are updated,
causing the zero-traffic arm's matrix to decay toward singularity.
"""
...
from bandit_v2 import DisjointLinUCBPolicy, RouterConfig
