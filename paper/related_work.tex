...
We exclude FrugalGPT from our latency-constrained experiments, as its sequential cascading mechanism violates our strict requirement for deterministic sub-500ms time-to-first-token (TTFT). We exclude Semantic Router as it lacks a mechanism for quality-aware routing within a single semantic domain.
