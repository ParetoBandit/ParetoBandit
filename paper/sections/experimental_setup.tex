...
3. \textbf{BanditGPT ($\gamma=0.995$):} Our proposed system, initialized with warmup priors, utilizing geometric forgetting, and governed by the Primal-Dual `BudgetPacer` targeting a specific dollar budget.

All three conditions use the same exploration rate ($\alpha=0.1$) and prior strength ($n_\mathit{eff}=1000$).
