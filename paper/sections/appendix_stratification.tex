...
The stratification does not affect the routing evaluation (Table~\ref{tab:results}) or the bandit learning experiments (Figures~2--7), which are evaluated uniformly across all prompts regardless of their stratification key.
