...
To provide theoretical context for our router's design, we discuss the relationship between the spectral separation in Figure~\ref{fig:pca} and the expected convergence behavior of the meta-algorithm.
