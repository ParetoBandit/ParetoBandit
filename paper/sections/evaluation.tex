...
\begin{table}[!htbp]
\centering
\caption{\input{../experiments/01_stationary_budget_pacing/table_caption_setup.tex}}
\label{tab:setup}
\small
\begin{tabular}{@{}llr@{}}
\toprule
...
\caption{\input{../experiments/01_stationary_budget_pacing/figure_caption_pareto.tex}}
\label{fig:pareto}
\vspace{4pt}
\end{figure*}
...
\begin{table}[t]
\centering
\caption{\input{../experiments/02_budget_plus_drift/table_caption_compliance.tex}}
...
\caption{\input{../experiments/02_budget_plus_drift/figure_caption_dynamics.tex}}
...
\caption{\input{../experiments/03_catastrophic_failure/figure_caption_dynamics.tex}}
...
\caption{\input{../experiments/04_model_onboarding/figure_caption_onboarding.tex}}
