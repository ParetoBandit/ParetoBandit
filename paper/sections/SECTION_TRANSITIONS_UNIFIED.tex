...
\begin{itemize}
    \item \textbf{Performance:} $61.5\%$ gap closure to oracle (vs $45.9\%$ for RouteLLM); 95\% CI lower bound surpasses 100k-pair supervised router after ${\sim}400$ in-distribution label-free prompts at moderate-to-high budgets
