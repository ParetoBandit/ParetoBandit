...
\begin{enumerate}
    ...
    \item \textbf{Adaptation Dynamics (Section~\ref{sec:robustness_adaptation}):} Response to catastrophic failures and zero-shot model releases—two key production scenarios requiring online adaptation.
