...
\begin{itemize}
    \item \textbf{Performance:} $70.0\%$ gap closure to oracle (vs $46.2\%$ for RouteLLM); surpasses 100k-pair supervised router after ${\sim}300$--$400$ in-distribution label-free prompts at moderate-to-high budgets
