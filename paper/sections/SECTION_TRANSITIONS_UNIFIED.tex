...
\begin{itemize}
    \item \textbf{Performance:} $70.8\%$ gap closure to oracle (vs $46.2\%$ for RouteLLM); surpasses 100k-pair supervised router after only 400 in-distribution label-free prompts
