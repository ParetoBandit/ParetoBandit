...
To rigorously validate our integrated approach, we conduct seven experiments organized into three parts:
...
We presented \textbf{banditGPT}, an integrated framework for production-grade LLM routing combining semantic structure discovery, Corralling meta-learning, and semantic transfer. Through comprehensive validation (7 experiments, 1,871 prompts), we demonstrated:
