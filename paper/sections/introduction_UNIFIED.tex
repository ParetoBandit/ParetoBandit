...
\begin{enumerate}
    ...
    $65.9\%$ gap closure to oracle on frozen holdout (vs $46.2\%$ for RouteLLM) with catastrophic failure detection as a secondary safety benefit (95\% detection at $K{=}5$, gap vs.\ EMA narrows monotonically with portfolio size), semantic transfer for new model integration, and multi-seed statistical testing ($N{=}20$--$30$).
\end{enumerate}
