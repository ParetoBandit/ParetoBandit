...
Instead, we construct warmup priors from a held-out portion of our own LMSYS evaluation data, which covers all 10 portfolio models---a \emph{same-distribution} prior reflecting the practitioner workflow of seeding a router with a small batch of historical evaluations.
