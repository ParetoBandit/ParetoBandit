...
\caption{Figure 2: Feature Distribution Shift. (Top) The deployment distribution (Red) is significantly left-shifted compared to the training data (Blue), with PSI=0.275. (Bottom) This shift is driven by a higher prevalence of ``Easy Tasks'' in production than anticipated.}
\label{fig:shift}
\end{figure}
