...
The finite-horizon sublinear regret guarantees of the original CBwK analysis do not directly apply to this rate-constraint setting; we validate convergence and budget compliance empirically (Sections~\ref{sec:results}--\ref{sec:discussion}).
