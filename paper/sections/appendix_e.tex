...
The domain-adapted PCA concentrates routing-relevant variation more efficiently into PC1. The generic PCA shows a numerically positive but smaller effect; however, in the primary correlation-based analysis (Section~\ref{sec:semantic_structure}), we validate signal through comparison with 100 random projections rather than a generic PCA condition. Both PCAs are unsupervised---neither uses reward labels during training.
