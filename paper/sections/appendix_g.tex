...
router = BanditRouter.create(
  model_registry={  # K=3
    "llama-3.1-8b-instruct":  $0.07/M,
    "gemini-2.5-flash":       $0.15/M,
    "openai/gpt-4.1":         $2.00/M,
  },
  cost_penalty=0.7,  # aggressive
  exploration="balanced",
  use_corralling=True,
)
model_id, log = router.route(
  prompt, max_cost=3.0  # $/M ceiling
)
\end{verbatim}}
...
{\small\begin{verbatim}
router = BanditRouter.create(
  model_registry={  # K=3, with TTFT
    "llama-3.1-8b-instruct":  TTFT=0.15s,
    "gemini-2.5-flash":       TTFT=0.20s,
    "openai/gpt-4.1":         TTFT=0.50s,
  },
  cost_penalty=0.3,
...
model_id, log = router.route(
  prompt, max_latency=0.6  # TTFT ceil
)
\end{verbatim}}
...
router = BanditRouter.create(
  model_registry={  # K=4
    "mixtral-8x7b-instruct":  $0.24/M,
    "llama-3.1-70b-instruct": $0.64/M,
    "openai/gpt-4o":          $6.25/M,
    "claude-sonnet-4":        $9.00/M,
  },
  cost_penalty=0.0,  # quality-only
  exploration="aggressive",
  use_corralling=True,
)
# After 500 prompts, onboard specialist:
